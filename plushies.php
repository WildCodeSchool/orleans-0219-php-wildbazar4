    ...
    <?php
    $plushies = [
            ['name' => 'Hector' , 'price' => '63.99€' , 'color' => 'gris' , 'size' => '32cm' , 'description' => 'A 7 ans tu avais déjà lu les Misérables 3 fois ? Tu rigolais aux blagues de ton prof de latin ? Tu pleurais quand tu avais un 16/20 ? Alors achète ce doudou pour ton chérubin ! Cadeau de naissance hyper original, effet garanti ! Stock ultra limité.'],
            ...
            ['name' => 'Famille Sweet Bear' , 'price' => '159.99€' , 'color' => 'marron et blanc avec noeud papillon tartan' , 'size' => '25cm et 12cm' , 'description' => 'Pour tous les petits cœurs... Un peu écorchés, abîmés, fatigués ou en bonne santé... Ces doudous sont fait pour apporter de la douceur et du réconfort à son propriétaire. Cadeau de naissance idéal et original. Edition Limitée'],
    ...
    <div class="card-body d-flex flex-column acontainerarticle p-1">
      <p class="card-title aproductname m-0 text-center"><?php echo $plush['name'] ?></p>
      <p class="card-text align-self-center text-center aprix "><?php echo $plush['price'] ?></p>
    </div>
    </div>
    ...
    <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="tmodal<?php echo $i ?>"><?php echo $plush['name'] ?></h5>
        ...
        <div class="modal-body">
          <div class="row">
            ...
            <div class="col-6">
              <div class="row justify-content-center">
                <p class="aprix"><?php echo $plush['price'] ?></p>
              </div>

              <div class="row mt-5">
                <p>Description : <?php echo $plush['description'] ?></p>
              </div>
            </div>
            <!--ajouts-->
            <div class="container-fluid">
              <div class="row">
                <div class="col-6">
                  ...
                  <ul>
                    <li>Couleur : <?php echo $plush['color'] ?></li>
                    <li>Taille : <?php echo $plush['size'] ?></li>
                  </ul>
                </div>
                <div class="col-6">
